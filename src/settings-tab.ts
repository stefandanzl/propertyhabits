...
export class HabitSettingsTab extends PluginSettingTab {
    ...
    private renderBasicSettings(container: HTMLElement) {
        ...
        new Setting(section)
            ...
            .setDesc('Moment.js format pattern for your daily note structure (e.g., "YYYY/YYYY-MM/YYYY-MM-DD dd")')
            .addText((text) =>
                text
        ...
        new Setting(section)
            ...
            .setDesc('Enter the path to your daily note template file (e.g., "Templates/Daily Note.md")')
            .addText((text) =>
                text
        ...
        new Setting(section)
            ...
            .setDesc("Interval in milliseconds to scroll to the top of the daily note (0 to disable)")
            .addSlider((slider) =>
                slider
                    .setLimits(0, 900, 50)
                    .setDynamicTooltip()
    ...
    private renderHabitsList(container: HTMLElement) {
        ...
        if (this.plugin.settings.trackedHabits.length === 0) {
            ...
            emptyText.setText('No habits configured yet. Click "Add New Habit" to get started.');
            return;
        }
    ...
    private showAddHabitModal() {
        const modal = new AddHabitModal(this.app, this.dataProcessor, this.plugin, async (result) => {
    ...
    private editHabit(index: number) {
        ...
        const modal = new EditHabitModal(this.app, this.plugin, habit, async (result) => {
